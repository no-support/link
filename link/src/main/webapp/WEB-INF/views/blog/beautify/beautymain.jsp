     ...
     <!-- 헤더 끝  -->
        <div class="row">
            ...
            <div class="col-sm-10 blog_manage_right_row">
				...
				<form id="updateBlogForm" runat="server" action="beauty.do" method="post" enctype="multipart/form-data">
					<div class="row blog_manage_right_row2">
						<div class="col-sm-2">
							<strong>블로그명</strong>
						</div>
						<div class="col-sm-5">
							<input class="form-control col-sm-12 blog_manage_input" type="text" name="title" value="${blog.title }" />
						</div>
						<div class="col-sm-5">
					...
					<div class="row blog_manage_right_row2">
						...
						<div class="col-sm-5">
							<textarea class="form-control col-sm-12" name="description" id="blogDescription" rows="6">${blog.description }</textarea>
						</div>
						<div class="col-sm-5">
					...
					<div class="row blog_manage_right_row2">
						...
						<div class="col-sm-5">
							<select class="form-control blog_beauty_subject" name="topic" id="">
								...
								<option ${blog.topic eq 'programming' ? 'selected' : ''} value="programming">프로그래밍</option>
								<option ${blog.topic eq 'streamming' ? 'selected' : ''} value="streamming">스트리밍</option>
							</select>
						</div>
					...
					<div class="row ">
						<div class="col-sm-12 text-center blog_beauty_bottombtndiv">
							<button type="button" class="btn blog_beuaty_submit_button">적용</button>
						</div>
					</div>
				</form>
			</div>
