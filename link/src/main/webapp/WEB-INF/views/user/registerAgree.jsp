...
<div id="d1" class="text-center">
 <h2 align="center">회원가입을 환영합니다.</h2><br/><br/>
  <tr>
   ...
   <td><input type="checkbox" name="all" id="all"></td><hr style="width: 700px;"/>
  </tr>
 <div id="accordion">
  
   <h3><a href="#"><font size="2">Link 포털사이트 이용약관 동의(필수)</font><input type="checkbox" name="c1" id="c1"/></a></h3>
...
6. 이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도 등을 차단합니다.
  ...
  <tr>
   ...
   <td><input type="checkbox" name="c4" id="c4"></td><hr style="width: 700px;"/>
  </tr>
 
 <div align="center">
  <br/>
  <input class="btn-agree btn-primary" type="submit" value="동의">
  <input class="btn-agree" type="reset" value="비동의">
  <br/>
 </div>
</div>
</form>
