...
public class SeriesPagination {
	...
	public SeriesPagination(int page, int records) {   
		this.page = page;
		this.size = 10;
		this.pages = 10;
	...
	public SeriesPagination(int page, int size, int records) {   
		this.page = page;
		this.size = size;
		this.pages = 10;
		this.records = records;
	...
	public SeriesPagination(int page, int size, int pages, int records) {   
		this.page = page;
		this.size = size;
		this.pages = pages;
		this.records = records;
